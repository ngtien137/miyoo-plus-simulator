...
* **Màn hình chuẩn phần cứng:** Mô phỏng đúng tỉ lệ 4:3 độ phân giải gốc 640x480 IPS của Miyoo Mini Plus.
...
```
Hoặc click đúp vào file `tools/build_exe.bat`. Kết quả sẽ được cập nhật tự động vào thư mục `windows/`.
